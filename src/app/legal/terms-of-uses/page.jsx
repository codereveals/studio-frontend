...
const TermsOfUses = () => {
  return (
    <>
      <Breadcrumb title="Terms of Uses" />
      <Wrapper>
        <div className="w-full legal_content-wrapper rounded-md bg-purple-50 p-8">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Code Reveals.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Code Reveals, accessible from{" "}
                <a
                  href="https://codereveals.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://codereveals.com/
                </a>
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              <a
                href="https://codereveals.com/contact-us"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://codereveals.com/contact-us
              </a>
            </li>
          </ul>
        </div>
