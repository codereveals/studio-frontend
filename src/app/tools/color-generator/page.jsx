    ...
    <Wrapper>
      <div className="p-5 shadow-md rounded-lg my-10 min-h-[400px]">
        <div className="p-10 bg-teal-50 my-3 rounded-md">
          ...
          <p className="">
            A Random Color Generator is a tool or software that produces colors
            randomly, typically using hexadecimal codes or RGB values. It is
            used in web design, graphic design, UI/UX design, and other creative
            applications to generate diverse and vibrant color schemes
            effortlessly.
          </p>
        </div>
