    ...
    <Wrapper>
      <div className="p-5 shadow-md rounded-lg my-10 min-h-[400px]">
        <div className="p-10 bg-teal-50 my-3 rounded-md">
          ...
          <p className="">
            Text lowercase refers to converting all the letters in a given text
            to their lowercase form. This means transforming every uppercase
            (capital) letter to its corresponding lowercase (small) letter,
            while keeping the lowercase letters unchanged.
          </p>
          <p className="mt-2">
            For example, the text `Hello, WORLD!` would be converted to `hello,
            world!` when changed to lowercase. This is often used in text
            processing to standardize data, improve readability, or perform
