...
const SlugGenerator = () => {
  ...
  return (
    <>
      <Breadcrumb title="Slug Generator" />
      <Wrapper>
        <div className="p-5 shadow-md rounded-lg my-10 min-h-[400px]">
          <div className="p-10 bg-teal-50 my-3 rounded-md">
            ...
            <p className="">
              ...
              strings, typically used in web development to generate readable
              and search engine optimized URLs. It converts strings to
              lowercase, removes special characters, replaces spaces with
              dashes, and trims whitespace to create user-friendly URLs.
            </p>
          </div>
