      ...
      <Wrapper>
        <div className="p-5 shadow-md rounded-lg my-5 min-h-[400px]">
          <div className="p-10 bg-teal-50 my-3 rounded-md">
            ...
            <p className="">
              A word counter is a tool that counts the number of words in a
              given text. It is used in writing, editing, SEO, social media,
              academic work, and software development to ensure text meets
              specific word count requirements or limits.
            </p>
            <p className="mt-2">
