...
const GradientGenerator = () => {
  ...
  return (
    <>
      <Breadcrumb title="Random Gradient Generator" />
      <Wrapper>
        <div className="p-5 shadow-md rounded-lg  my-5  min-h-[400px]">
          <div className="p-10 bg-teal-50 my-3 rounded-md">
            ...
            <p className="">
              ...
              creates gradients with randomly selected colors. Gradients are
              color transitions that blend smoothly from one color to another,
              and they are commonly used in design, web development, and graphic
              design to create visually appealing backgrounds, buttons, and
              other UI elements. A random gradient generator can produce these
              gradients on demand, providing endless color combinations for
              creative use.
            </p>
          </div>
